...
(MRPI) set \citep{blanchini:2007}), for the closed-loop system governed by a fixed stabilising\NOTE{Really?! We don't really need it to be stabilising for this definition} state feedback 
controller $u=Kx$:
%
