...
In this section we present a numerical simulation for a simplified levitating ball model, as derived in~\cite{Schaich:2015}. \edit{The dynamics of the nonlinear system are given $m\ddot y = m g - c i^2/y^2$,
