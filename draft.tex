...
To initialise we start at the origin $\mathpzc x_0=0$, since we know that no constraints are active. Notice that the right hand side 
of~\eqref{eq:dist:cons} is updated the same way, a line-search is used to determine the active affine representation.
